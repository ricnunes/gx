<template>
  <div
    class="gx-section gx-section--five"
...
export default {
  ...
  methods: {
    ...
    animations() {
      ...
      const containerThree = document.getElementsByClassName("gx-section--five")[0];
      const thirdSection =
        containerThree.getElementsByClassName("right-to-center")[0];

      const thirdTitle = thirdSection.querySelectorAll(".content")[0];

      console.log('container: ', containerThree, ' section: ', thirdSection)
