<template>
  <div class="gx-section gx-section--three" v-observe-visibility="visibilityChanged">
...
export default {
  ...
  methods: {
    ...
    animations() {
      ...
      const firstSection = container.getElementsByClassName('right-to-center')[0]
      const secondSection = container.getElementsByClassName('left-to-center')[0]
      const thirdSection = container.getElementsByClassName('right-to-center')[1]
