<template>
  <div
    class="gx-section gx-section--four"
...
export default {
  ...
  methods: {
    ...
    animations() {
      ...
      const containerTwo = document.getElementsByClassName("gx-section--four")[0];
      const secondSection =
        containerTwo.getElementsByClassName("left-to-center")[0];

      const secondTitle = secondSection.querySelectorAll(".content")[0];
